# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2020-08-16 02:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(blank=True, max_length=60, null=True, verbose_name='文件存储在oss中的key')),
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='child', to='app01.FileRepository', verbose_name='父级目录')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Project', verbose_name='项目')),
                ('update_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.UserInfo', verbose_name='最近更新者')),
            ],
        ),
    ]
